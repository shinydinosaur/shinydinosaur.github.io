...
<div class="message">
  How to set up an ipython notebook session on a remote server and connect to it on your local machine.
</div>

Sometimes (ok usually) you run long-running computations on a remote server but would like the convenience of looking at your results locally. This is my current solution to this problem which also plays really well with caffe.
...
2. Start a browser and point it to: http://localhost:8888/

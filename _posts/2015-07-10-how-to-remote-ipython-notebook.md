...
2. Start a browserless session of ipython notebook in your screen: {% highlight js %} ipython notebook --no-browser {% endhighlight %}
3. Background your screen session (Ctrl-D).

## Connect to your ipython notebook session from your local computer
1. In a shell in your local computer type: {% highlight js %} ssh -NL 8888:localhost:8888 [YOUR SEVER NAME] {% endhighlight %}
2. Start a browser and point it to: {% highlight js %} http://localhost:8888/ {% endhighlight %}
